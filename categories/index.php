                        ...
                        <?php else: ?>
                            <div class="table-responsive">
                                <table class="table table-striped table-hover">
                                    ...
                                    $count_stmt->bind_param("i", $category['st_ct_id']); // "i" = integer
                                    $count_stmt->execute();

                                    $result = $count_stmt->get_result();
                                    $count_row = $result->fetch_assoc(); // mysqli me fetch_assoc use hota hai

                                    $product_count = $count_row['count'] ?? 0; // agar null ho to 0
